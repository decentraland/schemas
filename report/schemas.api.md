...
export namespace TipReceivedEvent {
    const // (undocumented)
    schema: JSONSchema<TipReceivedEvent>;
    const // (undocumented)
    validate: ValidateFunction<TipReceivedEvent>;
}
